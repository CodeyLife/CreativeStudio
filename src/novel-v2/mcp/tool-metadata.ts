...
export const TOOL_GROUPS: ToolGroup[] = [
  ...
  { key: "bootstrap", title: "规划与创作", tools: ["novel_bootstrap_run", "novel_story_arc_start", "novel_story_arc_get", "novel_story_arc_review", "novel_story_arc_batch_start", "novel_story_arc_orchestrate", "novel_chapter_review", "novel_chapter_review_issue_add", "novel_chapter_generate", "novel_chapter_script_h3", "novel_short_script_h3"] },
...
const SHORT_LABELS: Partial<Record<ToolName, string>> = {
  ...
  novel_chapter_review_issue_add: "追加章节审校意见",
  novel_chapter_generate: "生成章节",
  novel_chapter_script_h3: "章节短剧剧本提示词",
  novel_short_script_h3: "创意短剧脚本提示词",
