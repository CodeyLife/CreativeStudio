...
const SHORT_LABELS: Partial<Record<ToolName, string>> = {
  ...
  novel_skill_get: "读取运行时 Skill 指引",
  novel_short_script_h3_submit: "提交外部产出短剧脚本",
  novel_chapter_script_h3_submit: "提交外部产出章节短剧",
