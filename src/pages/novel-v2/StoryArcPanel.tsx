...
type ArcPlan = { title: string; objective: string; entryState: string; centralConflict: string; development: string[]; resolution: string; exitState: string; plotThreadRefs: string[]; threadResponsibilities?: ThreadResponsibility[]; foreshadowingRefs: string[]; expectedChapterCount: number; phases: Array<{ title: string; objective: string; exitCondition: string }>; authorIntent?: string };
