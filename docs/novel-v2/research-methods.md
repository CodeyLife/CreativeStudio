...
| [《雪中悍刀行》作品评论](https://wyb.chinawriter.com.cn/attachment/202206/27/04f63628-7894-42d9-877f-3a01295799a7.pdf) | 主角之外的人物也有欲望、牵挂和选择；日常与幽默可以调节沉重叙事 | `characters` 的欲望、行动与代价；关系信息可作为核心规划的可选结构；prose-reviewer 按适用性观察语言和幽默，不强制每章插笑点 | 不复制江湖话语、人物名、招式、豪情句式 |
...
| [叙事社会网络研究](https://arxiv.org/abs/2008.10835) | 更复杂、动态的关系网络可增加叙事层次和文学性 | 人物与架构规划可选记录关系方向、变化条件和选择后果；审核关注正文中可观察的独立行动，不把关系图复杂度变成逐章门槛 | 不追求关系图越复杂越好；复杂度必须服务可理解的因果与人物选择 |
...
公开证据
  ...
  -> Foundation：5 个核心阶段的 structured contract + foundationReview
  -> Story Arc：章节因果、起止状态、场景执行信息与连续性边界
  -> Draft/Review/Commit：三类 reviewer、当前 fingerprint、局部退化守卫
